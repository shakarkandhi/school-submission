...
cursor = conn.cursor()
cursor.execute('SELECT * FROM DATA_WINCC.dbo.Table_3')
...
def w2cmd():
    ...
    s1=r"<img src = 'download.png' width=100px/><font size=5><b>Akums Drugs & Parmaceuticals Ltd.</b></font><h2 style='text-align: center;'> Medicament Aduit Trail Report</h2>"
...
tk.Label(m, text='Medicament Audit Trail',anchor='w').grid(row=1,column=1,columnspan=2)

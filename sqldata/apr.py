...
def w1cmd():
    ...
    while(x<slen):
        ...
        x+=1  
    s=a
    s0=r"<html><head><style>table#t01, td {  border-collapse: collapse;  border: 1px solid black;}</style></head><img src = 'download.png' width=100px/><font size=5><b>Akums Drugs & Parmaceuticals Ltd.</b></font><h2 style='text-align: center;'> Medicament Process Report</h2>"
    ...
    f1=r"<br><table  id='t01' class='dataframe'>  <thead>    <tr style='text-align: center;'>      <th></th>      <th colspan=2>STILER RPM</th>      <th width=50px>VOLTAGE (STILLER)</th>      <th colspan=2>VACUUM</th>      <th width=50px>CURRENT (STILER)</th>      <th colspan=4>PROCESS TIME</th>    </tr>  </thead>  <thead>    <tr style='text-align: center;'>      <th>DATE/TIME</th>      <th>SET</th>      <th>ACTUAL</th>      <th>ACTUAL</th>      <th>SET</th>      <th>ACTUAL</th>      <th>ACTUAL</th>      <th colspan=2>SET</th>      <th colspan=2>ACTUAL</th>    </tr>  </thead>  <thead>    <tr style='text-align: center;'>      <th></th>      <th>(rpm)</th>      <th>(rpm)</th>      <th>(Volt)</th>      <th>(mmHg)</th>      <th>(mmHg)</th>      <th>(A)</th>      <th>(Min)</th>      <th>(Sec)</th>      <th>(Min)</th>      <th>(Sec)</th>    </tr>  </thead>"
...
fd = pd.DataFrame(ft,columns=['Date Time','RPM1','RPM2','RPM3','RPM4','RPM5','RPM6','RPM7','RPM8','RMP9','RPM10','NOP','NOO','MFG DATE','EXP. DATE','BNO','BSIZE','LOTNO','LOTSIZE'])
